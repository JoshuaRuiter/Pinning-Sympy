...
Write new pinned\_group class, with the first goal of getting a minimal working example running involving special linear groups.
...
\subsection{Minimal working example -- special linear groups}
