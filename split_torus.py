...
class split_torus:
    ...
    def __init__(self, 
        ...
        # is_element should be a function that takes in a matrix,
        # and outputs a boolean
        self.is_element = is_element 
        
        # generic_element should be a function that takes in a string
        # and outputs a matrix
        self.generic_element = generic_element
        
        # trivial_character matrix should be a matrix
        # whose rows are a basis for the subgroup of trivial characters
        self.trivial_character_matrix = trivial_character_matrix
        
        # nontrivial_character_entries is a
        # binary tuple storing the nontrivial nonredundant entries
