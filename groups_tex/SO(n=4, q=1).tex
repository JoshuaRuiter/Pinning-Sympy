...
\title{Pinned group summary: \texttt{SO(n=4, q=1)}}
...
\begin{tabular}{|l|l|c|c|c|}
    ...
    \hline
    $\left( -1, \  0, \  0, \  0\right)$ & $\left( -2, \  2, \  0, \  0\right)$ & No & $-$ & No \\
    \hline
    $\left( 1, \  0, \  0, \  0\right)$ & $\left( 2, \  -2, \  0, \  0\right)$ & Yes & $+$ & No \\
    \hline
\end{tabular}
\end{center}
