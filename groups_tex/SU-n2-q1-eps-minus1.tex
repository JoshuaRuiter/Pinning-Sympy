...
\title{Pinned group summary: SU-n2-q1-eps-minus1}
...
\[
\left[\begin{matrix}x_{r 0 0} & - x_{r 0 1}\\- x_{r 1 0} & - x_{r 0 0}\end{matrix}\right]
\]
...
\noindent \begin{longtable}{|l|c|}
    ...
    \hline
    \endhead
    $\left( -2, \  0\right)$ & ${\left[\begin{matrix}0 & 0\\- u_{0} & 0\end{matrix}\right]}$ \\
    \hline
    $\left( 2, \  0\right)$ & ${\left[\begin{matrix}0 & - u_{0}\\0 & 0\end{matrix}\right]}$ \\
    \hline
\end{longtable}
...
\noindent \begin{longtable}{|l|c|}
    ...
    \hline
    \endhead
    $\left( -2, \  0\right)$ & ${\left[\begin{matrix}1 & 0\\- u_{0} & 1\end{matrix}\right]}$ \\
    \hline
    $\left( 2, \  0\right)$ & ${\left[\begin{matrix}1 & - u_{0}\\0 & 1\end{matrix}\right]}$ \\
    \hline
\end{longtable}
...
\noi \noindent \begin{tabular}{|l|c|}
    ...
    \hline
    $\left( -2, \  0\right)$ & ${\left[\begin{matrix}0 & 1\\-1 & 0\end{matrix}\right]}$ \\
    \hline
    $\left( 2, \  0\right)$ & ${\left[\begin{matrix}0 & 1\\-1 & 0\end{matrix}\right]}$ \\
    \hline
\end{tabular}
...
\noi \noindent \begin{tabular}{|l|l|l|c|}
    ...
    \hline
    $\left( -2, \  0\right)$ & $\left( -2, \  0\right)$ & $\left( 2, \  0\right)$ & $- u_{0}$ \\
    \hline
    $\left( -2, \  0\right)$ & $\left( 2, \  0\right)$ & $\left( -2, \  0\right)$ & $- u_{0}$ \\
    \hline
    $\left( 2, \  0\right)$ & $\left( -2, \  0\right)$ & $\left( 2, \  0\right)$ & $- u_{0}$ \\
