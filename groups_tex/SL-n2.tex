...
\title{Pinned group summary: SL-n2}
...
\noi \begin{tabular}{|l|c|c|c|}
    ...
    \hline
    $\left( -1, \  1\right)$ & No & $-$ & No \\
    \hline
    $\left( 1, \  -1\right)$ & Yes & $+$ & No \\
    \hline
\end{tabular}
...
\noindent \begin{longtable}{|l|c|}
    ...
    \hline
    \endhead
    $\left( -1, \  1\right)$ & ${\left[\begin{matrix}0 & 0\\u_{0} & 0\end{matrix}\right]}$ \\
    \hline
    $\left( 1, \  -1\right)$ & ${\left[\begin{matrix}0 & u_{0}\\0 & 0\end{matrix}\right]}$ \\
    \hline
\end{longtable}
...
\noindent \begin{longtable}{|l|c|}
    ...
    \hline
    \endhead
    $\left( -1, \  1\right)$ & ${\left[\begin{matrix}1 & 0\\u_{0} & 1\end{matrix}\right]}$ \\
    \hline
    $\left( 1, \  -1\right)$ & ${\left[\begin{matrix}1 & u_{0}\\0 & 1\end{matrix}\right]}$ \\
    \hline
\end{longtable}
...
\noi \noindent \begin{tabular}{|l|c|}
    ...
    \hline
    $\left( -1, \  1\right)$ & ${\left[\begin{matrix}0 & 1\\-1 & 0\end{matrix}\right]}$ \\
    \hline
    $\left( 1, \  -1\right)$ & ${\left[\begin{matrix}0 & 1\\-1 & 0\end{matrix}\right]}$ \\
    \hline
\end{tabular}
...
\noi \noindent \begin{tabular}{|l|l|l|c|}
    ...
    \hline
    $\left( -1, \  1\right)$ & $\left( -1, \  1\right)$ & $\left( 1, \  -1\right)$ & $- u_{0}$ \\
    \hline
    $\left( -1, \  1\right)$ & $\left( 1, \  -1\right)$ & $\left( -1, \  1\right)$ & $- u_{0}$ \\
    \hline
    $\left( 1, \  -1\right)$ & $\left( -1, \  1\right)$ & $\left( 1, \  -1\right)$ & $- u_{0}$ \\
