...
\newcommand{\NameText}{\texttt{SL(n=3)}}
\newcommand{\MatrixSize}{3}
\newcommand{\Rank}{2}
...
\begin{tabular}{|l|l|c|c|c|}
    ...
    \hline
    $\left( -1, \  0, \  1\right)$ & $\left( -1, \  0, \  1\right)$ & No & $-$ & No \\
    \hline
    $\left( -1, \  1, \  0\right)$ & $\left( -1, \  1, \  0\right)$ & No & $-$ & No \\
    \hline
    $\left( 0, \  -1, \  1\right)$ & $\left( 0, \  -1, \  1\right)$ & No & $-$ & No \\
    \hline
    $\left( 0, \  1, \  -1\right)$ & $\left( 0, \  1, \  -1\right)$ & Yes & $+$ & No \\
    \hline
    $\left( 1, \  -1, \  0\right)$ & $\left( 1, \  -1, \  0\right)$ & Yes & $+$ & No \\
    \hline
    $\left( 1, \  0, \  -1\right)$ & $\left( 1, \  0, \  -1\right)$ & No & $+$ & No \\
    \hline
\end{tabular}
