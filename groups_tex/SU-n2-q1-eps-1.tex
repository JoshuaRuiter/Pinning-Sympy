...
\title{Pinned group summary: SU-n2-q1-eps-1}
...
\[
\left[\begin{matrix}x_{r 0 0} & \sqrt{d} x_{i 0 1}\\\sqrt{d} x_{i 1 0} & - x_{r 0 0}\end{matrix}\right]
\]
...
\noi \begin{tabular}{|l|c|c|c|}
    ...
    \hline
    $\left( -2, \  0\right)$ & No & $-$ & No \\
    \hline
    $\left( 2, \  0\right)$ & Yes & $+$ & No \\
    \hline
\end{tabular}
...
\noindent \begin{longtable}{|l|c|}
    ...
    \hline
    \endhead
    $\left( -2, \  0\right)$ & ${\left[\begin{matrix}0 & 0\\\sqrt{d} u_{0} & 0\end{matrix}\right]}$ \\
    \hline
    $\left( 2, \  0\right)$ & ${\left[\begin{matrix}0 & \sqrt{d} u_{0}\\0 & 0\end{matrix}\right]}$ \\
    \hline
\end{longtable}
...
\noindent \begin{longtable}{|l|c|}
    ...
    \hline
    \endhead
    $\left( -2, \  0\right)$ & ${\left[\begin{matrix}1 & 0\\\sqrt{d} u_{0} & 1\end{matrix}\right]}$ \\
    \hline
    $\left( 2, \  0\right)$ & ${\left[\begin{matrix}1 & \sqrt{d} u_{0}\\0 & 1\end{matrix}\right]}$ \\
    \hline
\end{longtable}
...
\noi \noindent \begin{tabular}{|l|c|}
    ...
    \hline
    $\left( -2, \  0\right)$ & ${\left[\begin{matrix}0 & \sqrt{d}\\- \frac{1}{\sqrt{d}} & 0\end{matrix}\right]}$ \\
    \hline
    $\left( 2, \  0\right)$ & ${\left[\begin{matrix}0 & \sqrt{d}\\- \frac{1}{\sqrt{d}} & 0\end{matrix}\right]}$ \\
    \hline
\end{tabular}
...
\noi \noindent \begin{tabular}{|l|l|l|c|}
    ...
    \hline
    $\left( -2, \  0\right)$ & $\left( -2, \  0\right)$ & $\left( 2, \  0\right)$ & $- d u_{0}$ \\
    \hline
    $\left( -2, \  0\right)$ & $\left( 2, \  0\right)$ & $\left( -2, \  0\right)$ & $- \frac{u_{0}}{d}$ \\
    \hline
    $\left( 2, \  0\right)$ & $\left( -2, \  0\right)$ & $\left( 2, \  0\right)$ & $- d u_{0}$ \\
    \hline
    $\left( 2, \  0\right)$ & $\left( 2, \  0\right)$ & $\left( -2, \  0\right)$ & $- \frac{u_{0}}{d}$ \\
